      ...
      <div class="orderDiv" >
        ...
        <div class="divRight">
          ...
          <div class="orderInfo">
            ...
            <div class="infoInput"><input type="text" name="name" id="nameInput" required placeholder="성명"></div>

            <div class="infoTitle">전화번호</div>
            <div class="infoInput"><input type="tel" name="phone" id="phoneInput" required placeholder="전화번호"></div>

            <div class="infoTitle">이메일</div>
            <div class="infoInput"><input type="email" name="email" id="emailInput" required placeholder="이메일"></div>

            <div class="infoTitle">우편번호</div>
            <div class="infoInput">
              <input type="text" name="zipCode" id="zipcode" readonly placeholder="미지정" style="width:120px;">
